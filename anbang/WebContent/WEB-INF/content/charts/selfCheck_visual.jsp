...
<base href="<%=basePath%>">
 ...
 <script src="js/jquery.blockUI.js"></script>
  ...
  function getInfoData(){
	 ...
	 $.getJSON("charts/getSafetyCheckDate.do?epid=${sessionScope.epId}&start=${param.start}&end=${param.end}&chartType=ep",function(data){
	 		$.each(data,function(i,item){
	   			xax.push(item);
	 		});
	...
	$.getJSON("charts/getChartsVisual.do?epid=${sessionScope.epId}&start=${param.start}&end=${param.end}&type=ep",function(data){
		infoData=data;
		$.each(data,function(i,item){
...
<body>
  ...
  <div class="rightinfo">
 	...
 	<label for="from">开始日期</label>
			<input type="text" id="from" name="start" class="dfinput">
			<label for="to">结束日期</label>
			<input type="text" id="to" name="end" class="dfinput">
			<input type="hidden" id="type" name="type" value="dept" class="dfinput">
			<input type="hidden" name='epid' value="${sessionScope.epId}"/>
    		<input type="submit" class="btn" value="查询"/>
   
    </form>
	</div> 
    <div id="main" style="min-width:1000px;min-height:350px;float:none"> 
    ...
    <tr>
      <td style="height:250px;width:50%;">
        <div id="container" class="shadow" style="height:250px;padding-top:15px;overflow: hidden;"></div>
      </td>
      <td style="height:250px;width:50%; ">
        <div id="info" class="shadow" style="height:250px;margin-left:15px;text-align:center;overflow: auto;background-color:#f0ffff">
        </div>
      </td>
  	</tr>
  	</table>
  ...
  <div id="dialog" title="隐患信息">
      ...
      <label>编号</label><br>
      <input type="text" id="itemNumber"  class="text ui-widget-content ui-corner-all"/><br>
      <label>内容</label><br>
      <textarea id="itemContent" cols="60"class="text ui-widget-content ui-corner-all"></textarea><br>
      <label>依据</label><br>
      <textarea id="itemLaw" cols="60"class="text ui-widget-content ui-corner-all"></textarea><br>
      <label>现场情况</label><br>
       <textarea id="itemLive" cols="60"class="text ui-widget-content ui-corner-all"></textarea>
