...
<br>
<ul class = "forminfo">
<form:form action="unit/update.do" method="post" commandName="ut">
<li>
<form:input path="epid" name="" type="hidden" class="dfinput" value=" "  style="width:518px;"/></li>
 <form:input path="id" name="" type="hidden" class="dfinput" value=" "  style="width:518px;"/>
