...
<script type="text/javascript">
	...
	function checkSave(infoId){
		$.getJSON("check/isSaved.do?infoId="+infoId,function(data){
			if(data==false){
				confirmDialog.dialog("open");
				
			}
			else{
				window.location.href='check/commitCheck.do?infoId=${check.infoId}&epId=${sessionScope.epId}';
			}
...
<body>
    ...
    <li><a href="#tab3">查看结果</a></li> 
  	...
  	<div id="tab1" class="tabson">
		...
		<form:form  role="form" cssClass="form-inline" method="post" action="check/saveCheck.do" commandName="check">
			...
			<button type="button" onclick="javascript:window.location.href='check/cancel.do?infoId=${check.infoId}'"class="btn btn-default">取消</button>
			</div>
	...
	<div id="tab3" class="tabson">
  		<iframe src="check/toCheckDetail.do?infoId=${check.infoId}" height="890px" width="100%" scrolling="false"></iframe>
	</div>
