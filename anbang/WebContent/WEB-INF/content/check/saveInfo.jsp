...
<body>
 ...
 <form:form method="post" action="check/saveInfo.do" commandName="info" cssClass="form-horizontal" role="form" cssStyle="padding-top:4px">
   

	<div class="form-group">
  		 <label for="name" class="col-sm-2 control-label">检查部门</label>
  		 <div class="col-sm-10">
  		<form:input path="checkDept" cssClass="form-control input-lg"/>
   		<form:hidden path="checkDeptId"/>
   	...
   	<div class="form-group">
   		...
   		<select name="checkType" class="form-control input-lg">
					...
					<option value="特殊日期检查">特殊日期检查</option>
				</select>
				</div>
  	</div>
     <br>
