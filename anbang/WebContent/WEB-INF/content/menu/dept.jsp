...
<body style="background:#f0f9fd;">
    ...
    <span><img src="images/leftico01.png" /></span>监督管理信息
    	...
    	<ul class="menuson">
    	<li class="active"><cite></cite><a href="menu/toSafetyCheckVisual.do?start=2017-01-01&end=2017-12-31&type=dept" target="rightFrame">评估信息</a><i></i></li>
		<li><cite></cite><a href="check/toCheckList.do?pager.offset=0" target="rightFrame">监管检查</a><i></i></li>
    ...
    <span><img src="images/leftico01.png" /></span>企业管理信息
    	...
    	<ul class="menuson">
		<li><cite></cite><a href="menu/toSelfCheckVisual.do?start=2017-01-01&end=2017-12-31" target="rightFrame">自查数据</a><i></i></li>
        <li><cite></cite><a href="enterprise/toShow.do?epid=${sessionScope.epId}" target="rightFrame">企业信息</a><i></i></li>
